...
public class ConnectionHandler {
	 ...
	 * @throws IOException 
	 */
	public ConnectionHandler(Context context, AudioGroup audioGroup) throws IOException {
	...
	public void start() {
		...
		while (true) {
			...
			try {
				...
				SingleConnectionHandler handler = new SingleConnectionHandler(singleConnection);
	...
	public class SingleConnectionHandler implements Runnable {
		...
		public void run() {
			try {
				...
				InetAddress localAddress = this.getInetAddress();
				...
				Log.d(TAG, "Local addr: " + audioStream.getLocalAddress() + ":" + audioStream.getLocalPort());
				Log.d(TAG, "Remote addr: " + audioStream.getRemoteAddress() + ":" + audioStream.getRemotePort());
